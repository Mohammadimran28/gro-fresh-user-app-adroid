...
class _CheckoutScreenState extends State<CheckoutScreen> {
                                                                      ...
                                                                      TextButton
                                                                        ...
                                                                        onPressed: () => Navigator.pushNamed(
                                                                            ...
                                                                            RouteHelper.getAddAddressRoute(
                                                                                ...
                                                                                AddressModel()),
                                                                            arguments:
                                                                                AddNewAddressScreen(fromCheckout: true)),
                                                                        icon: Icon(
                                                                            Icons.add),
                                                                        label: Text(
                                                                            getTranslated('add',
                                                                  ...
                                                                  ? address.addressList
                                                                      ...
                                                                      ? ListView
                                                                          ...
                                                                          itemBuilder:
                                                                            ...
                                                                            bool
                                                                                _isAvailable =
                                                                                _branches.length == 1 && (_branches[0].latitude == null || _branches[0].latitude.isEmpty);
                                                                            if (!_isAvailable) {
                                                                          ...
                                                                          return Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                alignment: Alignment.center,
                                                                                decoration: BoxDecoration(color: order.selectTimeSlot == index ? Theme.of(context).primaryColor : ColorResources.getTimeColor(context), borderRadius: BorderRadius.circular(7), boxShadow: [
                                                                                  BoxShadow(color: Colors.grey[Provider.of<ThemeProvider>(context).darkTheme ? 800 : 100], spreadRadius: .5, blurRadius: .5)
                                                                                ]),
                                                                                child: Text(
                                                                                  ...
                                                                                  style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: order.selectTimeSlot == index ? Colors.white : Colors.grey[500]),
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          );
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  (_selfPickup || order.distance != -1) ? '(+) ${PriceConverter.convertPrice(context, _selfPickup ? 0 : _deliveryCharge)}' : getTranslated('not_found', context),
                                                                                  style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
                                                                                ),
                                                                              ]),
                                                                          Padding(
                                                            ...
                                                            ? address.addressList
                                                                ...
                                                                ? ListView
                                                                    ...
                                                                    itemBuilder:
                                                                        (context,
                                                                            index) {
                                                                      bool _isAvailable = _branches.length ==
                                                                              1 &&
                                                                      ...
                                                                      if (!_isAvailable) {
                                                                        ...
                                                                        _isAvailable =
                                                                            _distance <
                                                                                _branches[order.branchIndex].coverage;
                                                                      }
                                                          ...
                                                          child: Container(
                                                            ...
                                                            decoration:
                                                              ...
                                                              boxShadow: [
                                                                BoxShadow(
                                                                    color: Colors
                                                                        .grey[Provider.of<ThemeProvider>(context)
                                                                            .darkTheme
                                                                        ? 800
                                                                        : 100],
                                                                    spreadRadius:
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      (_selfPickup ||
                                                                              order.distance !=
                                                                                  -1)
                                                                          ? '(+) ${PriceConverter.convertPrice(context, _selfPickup ? 0 : _deliveryCharge)}'
                                                                          : getTranslated(
                                                                              'not_found',
                                                                              context),
                                                                      style: poppinsRegular.copyWith(
  ...
  Container _placeOrderButton(BuildContext context, bool _selfPickup,
      OrderProvider order, bool _kmWiseCharge, double _deliveryCharge) {
    return Container(
      width: 1170,
      child: CustomButton(
        ...
        onPressed: () {
          if (!_selfPickup && order.addressIndex == -1) {
            ...
            showCustomSnackBar(
                getTranslated('delivery_fee_not_set_yet', context), context,
                isError: true);
            ...
            for (int index = 0; index < _cartList.length; index++) {
              Cart cart = Cart(
                ...
                discountAmount: _cartList[index].discountedPrice,
                quantity: _cartList[index].quantity,
                taxAmount: _cartList[index].tax,
                variant: '',
                variation: [
                  Variation(
                      type: _cartList[index].variation != null
                          ? _cartList[index].variation.type
                          : null)
                ],
              );
              carts.add(cart);
            ...
            PlaceOrderBody _placeOrderBody = PlaceOrderBody(
              ...
              deliveryAddressId: !_selfPickup
                  ? Provider.of<LocationProvider>(context, listen: false)
                      ...
                      .id
                  : 0,
              distance: _selfPickup ? 0 : order.distance,
              couponDiscountAmount:
                  Provider.of<CouponProvider>(context, listen: false).discount,
              timeSlotId: order.timeSlots[order.selectTimeSlot].id,
              paymentMethod: _isCashOnDeliveryActive
                  ? order.paymentMethodIndex == 0
                      ? 'cash_on_delivery'
                      : null
                  : null,
              deliveryDate: order.getDates(context)[order.selectDateSlot],
              couponDiscountTitle: '',
              orderAmount: widget.amount + _deliveryCharge,
            );
            ...
            if (_isCashOnDeliveryActive &&
              ...
              final String _placeOrder = convert.base64Url.encode(convert.utf8
                  .encode(convert.jsonEncode(_placeOrderBody.toJson())));
              ...
              if (ResponsiveHelper.isWeb()) {
                order.clearPlaceOrder().then((_) {
                  order
                      .setPlaceOrder(_placeOrder)
                      .then((value) => html.window.open(selectedUrl, "_self"));
                });
              } else {
