...
class ProductWidget extends StatelessWidget {
        ...
        if (cartProvider.cartList != null) {
          if (product.variations.length > 0) {
            for (int index = 0; index < product.variations.length; index++) {
              _price = product.variations.length > 0
                  ? product.variations[index].price
                  : product.price;
              _stock = product.variations.length > 0
              ...
              _cartModel = CartModel(
                  ...
                  product.variations.length > 0
                      ...
                      : null,
                  (_price -
                      PriceConverter.convertWithDiscount(context, _price,
        ...
        return ResponsiveHelper.isDesktop(context)
            ? OnHover(
                ...
                child: _productGridView(
                    context, isExistInCart, _stock, _cartModel, cardIndex),
              )
            : isGrid
                ? _productGridView(
                    context, isExistInCart, _stock, _cartModel, cardIndex)
                                ...
                                !isExistInCart
                                    ? InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Icon(
                                              Icons.add, //this is plus icon ATC
  ...
  InkWell _productGridView(BuildContext context, bool isExistInCart, int _stock,
      CartModel _cartModel, int cardIndex) {
