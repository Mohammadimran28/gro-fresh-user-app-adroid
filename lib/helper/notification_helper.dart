      ...
      onDidReceiveNotificationResponse: (NotificationResponse notificationResponse) async {
        ...
        try{
          if(notificationResponse != null && notificationResponse.payload.isNotEmpty) {
            MyApp.navigatorKey.currentState.push(MaterialPageRoute(builder: (context) =>
                OrderDetailsScreen(orderModel: null, orderId: int.parse(notificationResponse.payload))),
            );
          }
        }catch (e) {}
        return;
